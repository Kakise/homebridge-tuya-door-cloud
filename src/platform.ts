...
import { TuyaDoor } from './platformAccessory';
 ...
 */
export class TuyaDoorPlatform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    const devices = this.config.defaults;
    ...
    for (const device of devices) {
      ...
      if (existingAccessory) {
        ...
        new TuyaDoor(this, existingAccessory);
